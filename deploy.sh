...
for f in DearLordStats/*.lua 0DearLordKeeper/Keeper.lua; do luajit -bl "$f" >/dev/null; done
...
cp 0DearLordKeeper/Keeper.lua 0DearLordKeeper/0DearLordKeeper.toc "$ADDONS/0DearLordKeeper/"
